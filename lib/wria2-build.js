...
var async = require('async'),
  ...
  userChoices = {
    ...
    tmpClonePath: path.join(os.tmpdir(), tmpBuildDirName)
  };
...
function _war(options, done) {
  ...
  fullWar = [
    ...
    function (callback) {
      var time = (process.platform === 'win32') ? 22 : 13;
    ...
    function (callback) {
      ...
      log.echo('You may want to remove the cloned repo: ',
        path.resolve(userChoices.tmpClonePath));
      callback();
    }
  ];
